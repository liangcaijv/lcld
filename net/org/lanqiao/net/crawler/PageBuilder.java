...
public class PageBuilder {
  ...
  public static PageBuilder of(String classPathXmlLocation) {
  ...
  private static void build(Element root, PageBuilder instance) {
  ...
  public static void main(String[] args) {
    System.out.println( PageBuilder.of( "ftchinese-list.xml" ).build() );
  }
  ...
  public PageBuilder setPrefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
  ...
  public PageBuilder setXlink(String xlink) {
    this.xlink = xlink;
    return this;
  }
  ...
  public PageBean build() {
    ...
    // jdk 7 新用法
    try (WebClient webClient = HtmlUnitHelper.buildWebClient( enableJs )) {
  ...
  private void dealParams(PageBean bean, HtmlPage hPage) {
    for (String k : params.keySet()) {
      String nodeValue = HtmlUnitHelper.getNodeValue( hPage, params.get( k ) );
  ...
  public PageBuilder addXpath(String name, String xPath) {
  ...
  public PageBuilder enableJs(int wait) {
    this.enableJs = true;
    this.wait = wait;
    return this;
  }
   ...
   * @return
   */
  public PageBuilder setPaging(String nextPageHrefXpath, int pageLimit) {
    this.nextPageHrefXpath = nextPageHrefXpath;
    this.pageLimit = pageLimit;
    return this;
  }

  public PageBuilder click(String xpath) {
